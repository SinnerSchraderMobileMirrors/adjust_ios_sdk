## Migrate your adjust SDK for iOS to v3.3.2 from v3.0.0
...
3. Download version v3.3.2 and drag the new folder `Adjust` into your Xcode
   Project Navigator.
...
The adjust SDK v3.3.2 added delegate callbacks. Check out the [README] for
details.
...
2. The adjust SDK for iOS 3.3.2 uses [ARC][arc]. If you haven't done already,
